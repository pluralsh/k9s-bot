...
def main(voice, alive):
    ...
    devices = sd.query_devices("USB PnP")
    print("Input Devices: ", json.dumps(devices, indent=2))
    devices = sd.query_devices("UACDemo")
    print("Output Devices: ", json.dumps(devices, indent=2))
